//+------------------------------------------------------------------+
//| MAR2.1_AGRESSIVO_INVERTIDO - Mean Reversion Version 5.50         |
//+------------------------------------------------------------------+
#property strict
...
void PlaceOrders(double high,double low)
{
   ...
   // Lógica Invertida: Contra-Tendência (Mean Reversion Breakout)
   if(bid < CachedEMA)
      PlaceBuy(buyEntry);
