...
Abre uma nova posição na direção da tendência detectada.
Define o nível de stop loss (SL) baseado na última linha de suporte ou resistência (Smax ou Smin).
Calcula o tamanho da posição (lot_size) proporcional ao risco definido (1% do saldo).
Gestão das Posições:
